...
const STEPS = [
  ...
  { sel: '[data-tutorial="install"]', title: 'Install Guide', text: 'Grab the Auto Installer and it drops exported liveries straight into your game files — no manual copying. Prefer to do it yourself? The manual steps are here too.', placement: 'bottom' },
